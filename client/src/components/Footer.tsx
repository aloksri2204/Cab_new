...
const serviceLinks = [
  { name: "City Rides", href: "#pricing" },
  { name: "Hourly Service", href: "#pricing" },
  { name: "Airport Transfers", href: "#pricing" },
  { name: "Business Travel", href: "#pricing" },
  { name: "Special Events", href: "#pricing" }
];
      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Your reliable ride, just a click away. Professional cab service with fixed rates and comfortable rides.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="text-primary h-5 w-5 mt-1 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span className="text-gray-300">Near Godowlia Crossing, Dashashwamedh, Varanasi - 221001</span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="text-primary h-5 w-5 mt-1 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-start">
                ...
                <a href="mailto:info@akhileshcab.com" className="text-gray-300 hover:text-primary transition-colors">
                  info@akhileshcab.com
                </a>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="text-primary h-5 w-5 mt-1 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {currentYear} AkhileshCab. All rights reserved.
          </p>
          <div className="flex space-x-4">
